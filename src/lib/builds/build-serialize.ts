...
export function serializeBuild(build: BuildWithRelations) {
  ...
  return {
    ...
    progressSpeed: build.progressSpeed,
    progressOutTimeMs: build.progressOutTimeMs,
    progressDurationMs: build.progressDurationMs,
    progressStepIndex: build.progressStepIndex,
    progressStepTotal: build.progressStepTotal,
