import { z } from "zod";
import { franchisePlacementSchema } from "@/lib/api/validators/franchise";
...
export const movieListQuerySchema = z.object({
  ...
  hasRus: z.string().optional(),
  hasOrig: z.string().optional(),
  rusChannels: z.string().optional(),
  rusFormat: z.string().optional(),
  rusTranslation: z.string().optional(),
  origChannels: z.string().optional(),
  origFormat: z.string().optional(),
  premiumRus: z.string().optional(),
  premiumOrig: z.string().optional(),
  hasLang: z.string().optional(),
...
export const movieFranchiseAttachSchema = z
  .object({
    ...
    target: franchisePlacementSchema.optional(),
  })
  .refine(
