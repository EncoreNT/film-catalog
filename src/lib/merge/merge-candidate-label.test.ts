...
} from "@/lib/merge/merge-candidate-label";
...
describe("formatMergeCandidateFacts", () => {
  it("describes a single release without title", () => {
    ...
    ).toBe("черновик · HDTVRip · Локальный диск · 1.4 ГБ · Master.E01.mkv");
  });
});
...
describe("formatMergeCandidateSelectLabel", () => {
  it("prefixes facts with card id", () => {
    expect(
      ...
      "#42 · черновик · HDTVRip · Локальный диск · 1.4 ГБ · Master.E01.mkv",
    );
  });
