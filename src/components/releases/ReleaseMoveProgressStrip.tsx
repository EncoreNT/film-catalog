...
export function ReleaseMoveProgressStrip({
  job,
  loading,
  onOpen,
  onCancel,
  ...
  return (
    <div
      className="border-b border-neural/20 bg-neural/[0.06] px-3 py-2.5 sm:px-5"
      role="status"
      aria-live="polite"
    >
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
        <div className="flex min-w-0 flex-1 items-start gap-2.5 sm:items-center">
          <span className="mt-0.5 shrink-0 text-neural sm:mt-0" aria-hidden>
            {job.status === "RUNNING" ? (
