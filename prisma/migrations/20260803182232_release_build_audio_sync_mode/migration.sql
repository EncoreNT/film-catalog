...
CREATE TABLE "new_ReleaseBuildTrack" (
    ...
    "audioSyncMode" TEXT NOT NULL DEFAULT 'NONE',
...
INSERT INTO "new_ReleaseBuildTrack" ("audioMode", "buildId", "channelTarget", "createdAt", "forced", "id", "isDefault", "keepOriginal", "kind", "offsetMs", "sortOrder", "sourceFilePath", "sourceReleaseId", "sourceStreamIndex", "sourceTrackLabel", "transcodeBitrate", "transcodeCodec") SELECT "audioMode", "buildId", "channelTarget", "createdAt", "forced", "id", "isDefault", "keepOriginal", "kind", "offsetMs", "sortOrder", "sourceFilePath", "sourceReleaseId", "sourceStreamIndex", "sourceTrackLabel", "transcodeBitrate", "transcodeCodec" FROM "ReleaseBuildTrack";
